...
const Container = styled.div`
  ...
  position: relative;
  width:fit-content;
  margin: 0 ${props => (props.isMobile || props.marginAuto) && 'auto'};
...
const Inliner = styled.div`
  ...
  position: relative;
`
export { FadeIn, Button, Button2, BuyButton, Title, BigTitle, Container, ContainerRate,Subtitle, Inliner, Paragraph, Grid }
